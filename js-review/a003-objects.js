...
INFORMATION
 ...
 Object.keys()
 Object.values() //ECMA 7
 Object.valueOf()
 _.keys(obj)
 _.functions(obj)
 _.findKey(obj, f(condition))
 _.forIn(obj, f(value, key))
 _.has(obj, 'keyName')
 _.mapKeys(obj, f(value, key))
 _.mapValues(obj, f(condition))


TRANSFORMATION
 _.invert(obj) //inverts keys and values
 _.omit(obj, valuesToOmit)
 _.pick(obj, propertiesToPick)
 _.pickBy(obj, condition)
